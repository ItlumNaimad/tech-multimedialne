<?php
/**
 * Plik: pages/stats.php (Wersja modułowa)
 * Cel: Widok statystyk tracker.js dla routera index.php.
 */
...
<div class="card shadow-sm">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <a href="index.php?page=scada" class="btn btn-outline-secondary btn-sm">Przejdź do Panelu SCADA</a>
    </div>
