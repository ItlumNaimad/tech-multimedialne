...
if (!$song_id) die("Nie wybrano utworu.");
...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card bg-dark text-white">
            <div class="card-header">Dodaj utwór do playlisty</div>
            <div class="card-body">
                <form action="scripts/add_song_handler.php" method="POST">
                    <input type="hidden" name="song_id" value="<?= htmlspecialchars($song_id) ?>">
